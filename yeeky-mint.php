    ...
    <div class="row">
		...
		<div class="row">
			<div class="col-sm-10 col-sm-offset-1">
                <div id="yeekee_block_group" class="btn-group mr-1" role="group" aria-label="First group">
                <?php for($i=0;$i<89;$i=$i+1) {  ?>
                    <button type="button" id="yeekee_result_<?php echo $i ?>" class="btn btn-secondary yeekee-block yeekee-block-active"><?php echo $i; ?></button>
